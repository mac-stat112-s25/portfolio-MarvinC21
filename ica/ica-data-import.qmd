...
> The data was collected from TMDb by the reviewers at Kaggle.com.
...
```{r}
imdb_temp <- read_csv("C:/Users/dwmjc/Desktop/School/Spring 2025/COMP112/portfolio-MarvinC21/data/imdb_5000_messy.csv")
```
...
> All categories and counts for each category
...
> To not modify anyone's work at the source
