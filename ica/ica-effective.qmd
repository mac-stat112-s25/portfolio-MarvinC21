...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Tempurature at 9am (Celsius)", y = "Temperature at 3pm (Celsius)", title = "Temperatures at Different Times Throughout Australia", color = "Location")  
```
...
```{r}
#| fig-cap: "Temperatures at 9am and 3pm in the Hobart, Uluru, and Wollongong Regions of Australia"

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9am (C)", y = "Temperature at 3pm (C)", color = "Location")  
```
