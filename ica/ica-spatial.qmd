...
fave_places <- read.csv("C:/Users/dwmjc/Downloads/our_fave_places.csv")
...
starbucks_mn <- filter(starbucks, State.Province == "MN", Country == "US")
...
> The majority of Starbucks are found in Japan, Europe, and America.
