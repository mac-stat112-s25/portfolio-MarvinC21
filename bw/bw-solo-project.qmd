...
ggplot() +
  ...
  theme_void() +
  labs(title = "Average Age of Congress Members in the 118th Congress by State", fill = "Average Age (yrs)")
```
...
ggplot() +
  ...
  theme_void() +
  labs(title = "Average Age of Congress Democrats in the 118th Congress by State", fill = "Average Age (yrs)")
```
...
ggplot() +
  ...
  theme_void() +
  labs(title = "Average Age of Congress Republicans in the 118th Congress by State", fill = "Average Age (yrs)")
```
